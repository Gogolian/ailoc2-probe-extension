...
- annotate the commit subject and body automatically via local Git hooks
...
flowchart LR
    ...
    D --> E[commit-msg adds the AI line percentage to the subject and AI/total counts to the body]
```
